...
import 'package:tik_tok_ui/animation/FadeAnimation.dart';
...
class _SplashPageState extends State<Splash> {
  ...
  void initState(){
    super.initState();
    Timer(Duration(seconds: 3), () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => RootApp())));
    _controller = VideoPlayerController.asset('assets/videos/Intro_Large.mp4')
    ..initialize().then((_) {
      setState(()  {
